...
public class Child extends Parent {
    ...
    //bir class i child class yaptigimizda parent class daki cont. a ulasmasi gerekir.
    //bu durumda parent class daki const. in
    ...
    Child(int sayi1,int sayi2){
        ...
        System.out.println("iki parametreli const.r");
